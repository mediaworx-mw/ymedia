    ...
    ?>
      ...
      <div style="width:100%;">
        ...
        <div class="graficos-multi graficos-multi-2">
          ...
          <div class="grafico_wrapper">
            ...
            <div id="grafico-mensual-2b" class="grafico-inner" style="min-height: 520px"></div>
          </div>
        </div>
        <br>
      ...
      <div style="width:100%;">
        ...
        <div class="graficos-multi graficos-multi-2">
          ...
          <div class="grafico_wrapper">
            ...
            <div id="grafico-mensual-3b" class="grafico-inner" style="min-height: 520px"></div>
          </div>
        </div>
        <br>
      ...
      <div style="width:100%;">
        ...
        <div class="graficos-multi graficos-multi-2">
          <div class="grafico_wrapper">
            <h4>Grp's formato</h4>
            <div id="grafico-mensual-6-lv" class="grafico-inner" style="min-height: 320px"></div>
          </div>
          <div class="grafico_wrapper">
            <h4>Grp's 20"</h4>
            <div id="grafico-mensual-6-sd" class="grafico-inner" style="min-height: 320px"></div>
          </div>
        </div>
        <br>
      ...
      <div style="width:100%;">
        <h2>Presión publicitaria por grupos - Acumulado Anual</h2>
        <p class="graficos-fuente">Fuente: <?php echo $newsletter_mensual['presion_publicitaria_por_grupos']['fuente']; ?></p>
        <p>Minutos</p>
        <div class="graficos-multi graficos-multi-2">
          <div class="grafico_wrapper">
            <h4>Grp's formato</h4>
            <div id="grafico-mensual-6b-lv" class="grafico-inner" style="min-height: 320px"></div>
          </div>
          <div class="grafico_wrapper">
            <h4>Grp's 20"</h4>
            <div id="grafico-mensual-6b-sd" class="grafico-inner" style="min-height: 320px"></div>
          </div>
        </div>
        <br>
        <div class="descripcion"><?php echo $newsletter_mensual['presion_publicitaria_por_grupos']['texto']; ?></div>
      ...
      <div style="width:100%;">
        <h2>Presión publicitaria por cadenas - Acumulado Anual</h2>
        <p class="graficos-fuente">Fuente: <?php echo $newsletter_mensual['presion_publicitaria_por_cadenas']['fuente']; ?></p>
        <p>Minutos</p>
        <div class="graficos-multi graficos-multi-2">
          <div class="grafico_wrapper">
            <h4>Grp's formato</h4>
            <div id="grafico-mensual-7b-lv" class="grafico-inner" style="min-height: 520px"></div>
          </div>
          <div class="grafico_wrapper">
            <h4>Grp's 20"</h4>
            <div id="grafico-mensual-7b-sd" class="grafico-inner" style="min-height: 520px"></div>
          </div>
        </div>
        <br>
        <div class="descripcion"><?php echo $newsletter_mensual['presion_publicitaria_por_cadenas']['texto']; ?></div>
      ...
      <div style="width:100%;">
        ...
        <div class="graficos-multi graficos-multi-2">
          <div class="grafico_wrapper">
            <h4>Grp's formato</h4>
            <div id="grafico-mensual-8-lv" class="grafico-inner" style="min-height: 520px"></div>
          </div>
          <div class="grafico_wrapper">
            <h4>Grp's 20"</h4>
            <div id="grafico-mensual-8-sd" class="grafico-inner" style="min-height: 520px"></div>
          </div>
        </div>
        <br>
      ...
      <div style="width:100%;">
        <h2>Presión publicitaria por targets - Acumulado Anual</h2>
        <p class="graficos-fuente">Fuente: <?php echo $newsletter_mensual['presion_publicitaria_por_targets']['fuente']; ?></p>
        <p>Minutos</p>
        <div class="graficos-multi graficos-multi-2">
          <div class="grafico_wrapper">
            <h4>Grp's formato</h4>
            <div id="grafico-mensual-8b-lv" class="grafico-inner" style="min-height: 520px"></div>
          </div>
          <div class="grafico_wrapper">
            <h4>Grp's 20"</h4>
            <div id="grafico-mensual-8b-sd" class="grafico-inner" style="min-height: 520px"></div>
          </div>
        </div>
        <br>
        <div class="descripcion"><?php echo $newsletter_mensual['presion_publicitaria_por_targets']['texto']; ?></div>
    ...
    <?php 
      ...
      require get_template_directory() . '/inc/graficos-newsletters/mensual/grafico-2b.php';
      require get_template_directory() . '/inc/graficos-newsletters/mensual/grafico-3.php';
      require get_template_directory() . '/inc/graficos-newsletters/mensual/grafico-3b.php';
      ...
      require get_template_directory() . '/inc/graficos-newsletters/mensual/grafico-6b.php';
      require get_template_directory() . '/inc/graficos-newsletters/mensual/grafico-7.php';
      require get_template_directory() . '/inc/graficos-newsletters/mensual/grafico-7b.php';
      require get_template_directory() . '/inc/graficos-newsletters/mensual/grafico-8.php';
      require get_template_directory() . '/inc/graficos-newsletters/mensual/grafico-8b.php';

      require get_template_directory() . '/inc/graficos-newsletters/mensual/grafico-9.php';
      require get_template_directory() . '/inc/graficos-newsletters/mensual/grafico-10.php';