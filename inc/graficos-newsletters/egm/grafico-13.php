...
function  graficoEGM13() {
  
  am4core.useTheme(am4themes_animated);

  // Create chart instance
  var chart = am4core.create("grafico-EGM-13", am4charts.XYChart);
  
  var sheet_name = 'InternetDispositivos';
  ...
  var sorted = input.sort((a, b) => (a[col2] > b[col2]) ? 1 : -1);
  ...
  var evolucion_str = Object.keys(datosGraficos[sheet_name][0]).filter(x => x.length > 10 && x !== category)[0];
...
var graficoEGM13_show = false;

jQuery('#grafico-EGM-13').waypoint(function() {
  if(!graficoEGM13_show) {
    graficoEGM13();
  }
  graficoEGM13_show = true;
}, {
  offset: '75%'
});
