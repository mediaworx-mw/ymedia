...
function  graficoEGM7() {
  
  am4core.useTheme(am4themes_animated);

  // Create chart instance
  var chart = am4core.create("grafico-EGM-7", am4charts.XYChart);
  
  var sheet_name = 'RadioCadena';
...
var graficoEGM7_show = false;

jQuery('#grafico-EGM-7').waypoint(function() {
  if(!graficoEGM7_show) {
    graficoEGM7();
  }
  graficoEGM7_show = true;
}, {
  offset: '75%'
});
