...
function  graficoEGM14() {
  
  am4core.useTheme(am4themes_animated);

  // Create chart instance
  var chart = am4core.create("grafico-EGM-14", am4charts.XYChart);
  
  var sheet_name = 'InternetActividades';
...
var graficoEGM14_show = false;

jQuery('#grafico-EGM-14').waypoint(function() {
  if(!graficoEGM14_show) {
    graficoEGM14();
  }
  graficoEGM14_show = true;
}, {
  offset: '75%'
});
