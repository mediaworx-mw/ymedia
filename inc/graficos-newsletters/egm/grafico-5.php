...
function  graficoEGM5() {
  
  am4core.useTheme(am4themes_animated);

  // Create chart instance
  var chart = am4core.create("grafico-EGM-5", am4charts.XYChart);
  
  var sheet_name = 'RevistasMensuales';
...
var graficoEGM5_show = false;

jQuery('#grafico-EGM-5').waypoint(function() {
  if(!graficoEGM5_show) {
    graficoEGM5();
  }
  graficoEGM5_show = true;
}, {
  offset: '75%'
});
