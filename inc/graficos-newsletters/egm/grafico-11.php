...
function  graficoEGM11() {
  
  am4core.useTheme(am4themes_animated);

  // Create chart instance
  var chart = am4core.create("grafico-EGM-11", am4charts.XYChart);
  
  var sheet_name = 'RadioGenDepS';
...
var graficoEGM11_show = false;

jQuery('#grafico-EGM-11').waypoint(function() {
  if(!graficoEGM11_show) {
    graficoEGM11();
  }
  graficoEGM11_show = true;
}, {
  offset: '75%'
});
