...
function  graficoEGM3() {
  
  am4core.useTheme(am4themes_animated);

  // Create chart instance
  var chart = am4core.create("grafico-EGM-3", am4charts.XYChart);
  
  var sheet_name = 'DiariosSoporte';
...
var graficoEGM3_show = false;

jQuery('#grafico-EGM-3').waypoint(function() {
  if(!graficoEGM3_show) {
    graficoEGM3();
  }
  graficoEGM3_show = true;
}, {
  offset: '75%'
});
