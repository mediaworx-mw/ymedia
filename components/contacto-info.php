<div class="contacto-info">
   <div class="contacto-info__inner">
     <button class="contacto-info__close"><i class="fas fa-times"></i></button>

     <div class="contacto-info__content">
       <table>
        <tbody>
          <tr>
            <td><strong>¿Qué empresa trata sus datos?</strong></td>
            <td>INTELIGENCIA Y MEDIA, S.A. (en adelante YMEDIA)</td>
          </tr>
          <tr>
          ...
          <tr>
              ...
              <td>No, tus datos no serán cedidos a terceras empresas.</td>
          </tr>
          <tr>
